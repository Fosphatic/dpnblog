...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] app/model/input-tag.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0f916af4/input-tag.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./input-tag.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./input-tag.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      newTag: '',
	      innerTags: [].concat((0, _toConsumableArray3.default)(this.tags)),
	      isInputActive: false
	    };
	  },
	  ...
	  watch: {
	    tags: function tags() {
	      this.innerTags = [].concat((0, _toConsumableArray3.default)(this.tags));
	    }
	  },
	  ...
	  methods: {
	    ...
	    addNew: function addNew(e) {
	      if (e && this.addTagOnKeys.indexOf(e.keyCode) === -1 && (e.type !== 'blur' || !this.addTagOnBlur) || this.isLimit) {
	        return;
	      }
	      if (e) {
	        e.stopPropagation();
	    ...
	    validateIfNeeded: function validateIfNeeded(tagValue) {
	      if (this.validate === '' || this.validate === undefined) {
	        return true;
	      } else if (typeof this.validate === 'string' && (0, _keys2.default)(validators).indexOf(this.validate) > -1) {
	        return validators[this.validate].test(tagValue);
	      } else if ((0, _typeof3.default)(this.validate) === 'object' && this.validate.test !== undefined) {
