<?php $view->script('post-edit', 'dpnblog:app/bundle/post-edit.js', ['vue', 'editor', 'uikit']) ?>
...
<form id="post" class="uk-form" v-validator="form" @submit.prevent="save | valid" v-cloak>
    ...
    <div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
        ...
        <div data-uk-margin>
            ...
            <a class="uk-button uk-margin-small-right" :href="$url.route('admin/dpnblog/post')">{{ post.id ? 'Close' : 'Cancel' | trans }}</a>
