<?php $view->script('post-index', 'dpnblog:app/bundle/post-index.js', 'vue') ?>
...
<div id="post" class="uk-form" v-cloak>
    ...
    <div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
        ...
        <div data-uk-margin>
            ...
            <a class="uk-button uk-button-primary" :href="$url.route('admin/dpnblog/post/edit')">{{ 'Add Post' | trans }}</a>
        ...
        <table class="uk-table uk-table-hover uk-table-middle">
            ...
            <tbody>
                <tr class="check-item" v-for="post in posts" :class="{'uk-active': active(post)}">
                    ...
                    <td>
                        <a :href="$url.route('admin/dpnblog/post/edit', { id: post.id })">{{ post.title }}</a>
                    </td>
